...
Vagrant::Config.run do |config|
  ...
  config.vm.provision :chef_client do |chef|
    chef.chef_server_url = "https://api.opscode.com/organizations/vitcloud"
    chef.validation_key_path = "./.chef/vitcloud-validator.pem"
    chef.validation_client_name = "vitcloud-validator"
